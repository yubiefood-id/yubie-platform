...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-grid">
      ...
      <div><span className="footer-label">Explore</span><Link href="/shop">Produk</Link><Link href="/recipes">Recipes</Link><Link href="/our-roots">Our Roots</Link><Link href="/impact">Impact</Link></div>
